...
var tableClient = {
    ...
    selected: 'http://scale-it.org/shopfloor#product03',
...
var LoadOptions = function (s) {
    var optionParent = document.getElementById('filter_selection');
    var optionRows = document.getElementById('tableId').childNodes[1].childNodes[0].childNodes;
    while (optionParent.childNodes.length > 1) {
        optionParent.removeChild(optionParent.childNodes[optionParent.childNodes.length - 1])
    }
    var o = document.createElement('option');
    o.innerHTML = 'all';
    optionParent.appendChild(o);
    for (var i = 0; i < optionRows.length; i++) {
        let o = document.createElement('option');
        o.innerHTML = optionRows[i].__data__;
        optionParent.appendChild(o)
    }
};
...
tableClient.htmltable = function () {
    ...
    startLength = (startLength === 0) ? head.length : startLength;
